        ...
        <div class="row">
              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                  <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="student_thesis">Thesis Details</a></li>
          ...
          <div class="col-sm-9 col-lg-10">
            ...
            <?php
              ...
              {
                if($_SESSION['message'] == "Document  Uploaded Successfully.")
                {
                  echo "<script>swal({
            ...
            <!-- Thesis Details -->
            <h1 align="left" style="padding: 10px 0px 0px 0px;">Thesis Details</h1>
            <div class="jumbotron">
              <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                  <form action="student_thesis_s" method="post">
                    <!-- thesis_title -->
                    <div class="form-group">
                      <label class="col-lg-3 control-label" style="margin-top:5px;">Thesis Title</label>
                      <div class="col-lg-9">
                        <div class="input-group" style="padding:0px 0px 10px 0px;">
                          ...
                          <?php
                            ...
                            $title = $row['title'];
                            if($count == 0)
                              echo "<input type='text' class='form-control input-sm' id='thesis_title' name='thesis_title' placeholder='Thesis Title' autofocus required>";
                            else
                              echo "<input type='text' class='form-control input-sm' id='thesis_title' name='thesis_title' value='$title' placeholder='Thesis Title' autofocus required>";
                          ?>
                        </div>
                      </div>
                    </div>
                    <!-- thesis_abs -->
                    <div class="form-group">
                      <label class="col-lg-3 control-label" style="margin-top:5px;">Thesis Abstract</label>
                      <div class="col-lg-9">
                        <div class="input-group" style="padding:0px 0px 10px 0px;">
                          <div class="input-group-addon input-sm"><i class="glyphicon glyphicon-duplicate"></i></div>
                          <?php
                          	$servername = "127.0.0.1";
                          	$username = "root";
                          	$password = "$@!Sai5171";
                            ...
                            if($count == 0)
                              echo "<textarea style='height:200px;resize: none;' class='form-control' id='thesis_abs' name='thesis_abs' placeholder='Copy the Abstract here' required></textarea>";
                            else
                              echo "<textarea style='height:200px;resize: none;' class='form-control' id='thesis_abs' name='thesis_abs' placeholder='Copy the Abstract here' required>$abstract</textarea>";
                          ?>
                        </div>
            ...
            <!-- -->
            <h1 align="left" style="padding: 10px 0px 0px 0px;">Upload Files</h1>
            <div class="jumbotron">
              <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                  <form action="student_pdf_s.php" enctype="multipart/form-data" method="post">
                    <!-- type -->
                    <div class="form-group">
                      <label class="col-lg-3 control-label" style="margin-top:5px;">Type</label>
                      <div class="col-lg-9">
                        <div class="input-group" style="padding:0px 0px 10px 0px;">
                    ...
                    <!-- pdf -->
                    <div class="form-group">
                      <label class="col-lg-3 control-label" style="margin-top:5px;">Add Publication File</label>
                      <div class="col-lg-9">
                        <div class="input-group" style="padding:0px 0px 10px 0px;">
                          <div class="input-group-addon input-sm"><i class="glyphicon glyphicon-tags"></i></div>
                          <input type="file" class="form-control input-sm" id="pdf" name="pdf" required>
                        </div>

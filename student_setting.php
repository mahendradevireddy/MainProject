              ...
              <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-2">
                  <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="student_setting">Profile Settings</a></li>
          ...
          <div class="col-sm-9 col-lg-10">
            ...
            <h1 align="left" style="padding: 10px 0px 0px 0px;">Settings</h1>
              <div class="jumbotron" style="margin-top:0px;">
                <div class="row">
                  <div clss="col-lg-12">
                    <form action="student_setting_s" method="post">
                      <!-- opass -->
              ...
              <div class="jumbotron">
                <div class="row">
                  <div clss="col-lg-12">
                    <form action="student_setting_s" enctype="multipart/form-data" method="post">
                      <!-- photo -->
                      <div class="form-group">
                ...
                <div class="row">
                  <div clss="col-lg-12">
                    <form action="student_setting_s" enctype="multipart/form-data" method="post">
                      <!-- photo -->
                      <div class="form-group">
                        <label class="col-lg-3 col-lg-offset-2 control-label" style="margin-top:10px;">Delete Account</label>
                        <div class="col-lg-5">
                          <input style="margin-top:0px;" class="btn btn-success" id="register_btn2" name="register_btn2" type="submit" value="Delete"/>
                        </div>
                      </div>
                    </form>
                  </div>
